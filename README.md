# Shiny Implementation of the Molecular Acquisition, Cleaning, and Evaluation in R (MACERShiny) information and example.

# Description:

This repository contains the MACER package located at rgyoung6/MACER. The Molecular Acquisition, Cleaning, and Evaluation in R (MACERShiny) is a tool to assemble, align, trim, and evaluate molecular sequence datasets from BOLD and GenBank.

# Citation

Young RG, Gill R, Gillis D, Hanner RH (2021) Molecular Acquisition, Cleaning and Evaluation in R (MACERShiny) - Publication coming
...
MACERShiny can be installed three ways.
...
> library(devtools)<br/>
> devtools::install_github("rgyoung6/MACERShiny")<br/>
